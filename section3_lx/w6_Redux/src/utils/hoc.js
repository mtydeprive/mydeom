...
export function withReduxPlus(mapStateToProps,mapDispatchToProps){
    return function HOC(InnerComponent){
        class OuterComponent extends React.Component{
            ...
            render(){
                return <InnerComponent {...this.props} {...this.state.reduxData} {...this.state.reduxMethod}></InnerComponent>
            }
        }
        return OuterComponent
    }
