...
router.get('/list',async(req,res)=>{
    ...
    const data=await db.find('goods',{},{skip,limit,sort})
    res.send(
...
router.put('/:id',async(req,res)=>{
    const {id}=req.params
    const {goods_name,price,sales_price,img_url,inventory,category}=req.body
    const newData={goods_name,price,sales_price,img_url,inventory,category}
